...
exports.getCurrentWord =
  exports.removeFromCurrentWord =
  exports.addToCurrentWord =
  exports.resetCurrentWord =
  exports.setUserName =
  exports.resetScores =
  exports.addPlayerScore =
  exports.getPlayerScore =
    void 0;
var player1 = {
  currentScore: 0,
  user: "",
...
function addToCurrentWord(player, currentCell) {
  player == 1
    ? player1.currentWord.push(currentCell)
...
function removeFromCurrentWord(player, currentCell) {
  var playerWord = player == 1 ? player1.currentWord : player2.currentWord;
